...
dataset_path = r"C:\Users\tahmasebis\PycharmProjects\ChartFC\data/"


#train_df=pd.read_csv('./MediaEval_VN_data\VN_half_data/valid_bbc_fake_im_rep.csv')
train_df=pd.read_json(r'C:\Users\tahmasebis\PycharmProjects\ChartFC\data/data.json')

#train_df.drop(train_df[train_df['imageId(s)'] == 'sandyB_real_4'].index, inplace = True)
#train_df=train_df.reset_index(drop=True)
#train_df.to_csv('./well_distributed_data/ME_train_manipulated_image.csv',index=False)
#train_df=train_df[50041:178911]
#train = pd.read_csv(dataset_path +'train.csv')
#train_manipulated=pd.read_csv(dataset_path +'train_changed_event2.csv')
#train_df=pd.concat([train,train_manipulated],axis=0,ignore_index=True)
...
np.save(dataset_path+'valid_bbc_fake_im_rep_features.npy', train_features)
print('completed')